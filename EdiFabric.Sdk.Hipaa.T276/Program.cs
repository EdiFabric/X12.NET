...
namespace EdiFabric.Sdk.Hipaa.T276
{
    class Program
    {
        ...
        static void Read()
        {
            var ediStream = File.OpenRead(Directory.GetCurrentDirectory() + @"\..\..\..\Files.Hipaa\RequestTransmission.txt");
        ...
        static TS276 BuildRequestTransmission(string controlNumber)
        {
            ...
            loop2000D1.DMG_SubscriberDemographicInformation = new DMG_DependentDemographicInformation();
            ...
            loop2000D2.DMG_SubscriberDemographicInformation = new DMG_DependentDemographicInformation();
            ...
            loop2000E.DMG_DependentDemographicInformation = new DMG_DependentDemographicInformation();
            ...
            loop2210E.SVC_ServiceLineInformation.CompositeMedicalProcedureIdentifier_01 = new C003_CompositeMedicalProcedureIdentifier();
            ...
            loop2210E.DTP_ServiceLineDate.AccidentDate_03 = "20050501";
