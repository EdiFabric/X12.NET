...
namespace EdiFabric.Examples.X12.T837P
{
    class EVVExample
    {
        ...
        {
            var ediStream = File.OpenRead(Directory.GetCurrentDirectory() + Config.TestFilesPath + @"\Hipaa\ClaimPaymentEVV.txt");
        ...
        public static TS837P BuildClaim(string controlNumber)
        {
            ...
            loop24001.AllDTP.DTP_Date_ServiceDate.DateTimePeriod_03 = "20160302-20160302";
            ...
            //  Attendant's Name
            loop24001.AllNM1.Loop2420D.NM1_SupervisingProviderName = new NM1_SupervisingProviderName();
